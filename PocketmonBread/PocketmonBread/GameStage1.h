...
{
public:
	Stage1(SDL_Window* gameWindow, SDL_Renderer* gameRender, Player* _gamePlayer);
	virtual ~Stage1();
...
private:
	...
	void selectButtonType(const STAGE_BUTTON::TYPE& buttonType);
	void renderButtons();
	...
	RectangleButton* stageButtons[STAGE_BUTTON::COUNT];
